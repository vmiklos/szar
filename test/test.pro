...
HEADERS += ../stub/VersionControl.hh ../server/server_lib.hh test.hh AuthTest.hh AdminTest.hh RootTest.hh ModelAdminTest.hh ResolverTest.hh ModelTest.hh RevisionTest.hh UserTest.hh UserAdminTest.hh
